...
spatial.networks <- simulate(simple.homophily.ergm,nsim=100,control=control.simulate.ergm(MCMC.interval=10000000,MCMC.burnin=10000000))

# simulate networks from directional ERGM, take 1000
directional.networks <- simulate(ideological.hierarchy.ergm,nsim=100,control=control.simulate.ergm(MCMC.interval=10000000,MCMC.burnin=10000000))

# save simulation results
save(list=c("spatial.networks","directional.networks"),file="ergm_simulation_results.RData")
