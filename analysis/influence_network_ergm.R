...
install.packages("network", Sys.getenv("R_LIBS_USER"), repos = "https://cran.cnr.berkeley.edu/")
install.packages("fields", Sys.getenv("R_LIBS_USER"), repos = "https://cran.cnr.berkeley.edu/")
install.packages("ergm", Sys.getenv("R_LIBS_USER"), repos = "https://cran.cnr.berkeley.edu/")
install.packages("texreg", Sys.getenv("R_LIBS_USER"), repos = "https://cran.cnr.berkeley.edu/")
install.packages("tidyverse", Sys.getenv("R_LIBS_USER"), repos = "https://cran.cnr.berkeley.edu/")
library(foreach,lib.loc=Sys.getenv("R_LIBS_USER"))
library(doParallel,lib.loc=Sys.getenv("R_LIBS_USER"))
library(network,lib.loc=Sys.getenv("R_LIBS_USER"))
library(fields,lib.loc=Sys.getenv("R_LIBS_USER"))
library(texreg,lib.loc=Sys.getenv("R_LIBS_USER"))
library(ergm,lib.loc=Sys.getenv("R_LIBS_USER"))
...
parallel_ergm_results <- foreach(i= all.combinations) %dopar% {
  netinf.ergm(i)
}
